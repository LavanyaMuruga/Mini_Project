 ...
 */
class Editpost extends \Magento\Backend\App\Action implements HttpGetActionInterface
{
    /**
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Embitel_Storelocator::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Embitel_Storelocator::store_post')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Embitel\Storelocator\Model\Post::class);
